...
2
 ```
 Существует термин *слабая ссылка* - это такая ссылка, которая не препядствует сборке мусора. Т.е. если последними оставшимися сслыками на объект оказываются слабые сслыки, тогда выдеоенная под объект память освобождается.
