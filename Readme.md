...
## Глава 11. Операторы присваивания, выражений и вывода.
	...
	![изображение](https://user-images.githubusercontent.com/116806816/203903809-c1427aab-83e1-445a-b3b4-7533c8a59211.png)
...
([1, 2, 3, 4, 5, 6, 's'], [1, 2, 3, 4, 5, 6, 's', 'pam'])
	...
	**print*
	...
	элементы в квадратных скобках не обязательны ежле чо.
